...
import com.differentdoors.hubspot.models.Objects.User;
...
public class UsersService {
    ...
    public HResults<HObject<User<String>>> searchUsers(Search search) throws Exception {
        Map<String, String> urlParams = new HashMap<>();
        urlParams.put("path", "crm/v3/objects/users/search");
    ...
    private static String getClassProperties() {
        return Arrays.stream(User.class.getDeclaredFields()).map(Field::getName).collect(Collectors.joining(","));
    }
